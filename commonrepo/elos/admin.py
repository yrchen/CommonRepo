...
class ELOAdmin(CompareVersionAdmin):
    fieldsets = [
        ('ELO Info', {
            'fields': [
                'name', 'fullname', 'author', 'description', 'uuid', 'is_public', 'init_file'
                ]
            }),
        ('ELO Metadata', {
            'fields': [
                'original_type', 'metadata', 'license'
                ]
            }),
        ('ELO Version', {
            'fields': [
                'version', 'parent_elo', 'parent_elo_uuid', 'parent_elo_version'
                ]
            }),
    ]
...
class ELOMetadataAdmin(CompareVersionAdmin):
    fieldsets = [('Gerneral',
                 ...
                 ('Meta-metadata',
                  {'fields': ['Meta_metadata_identifier_catalog',
                 ...
                 ('Educational',
                  {'fields': ['Educational_interactivityType',
