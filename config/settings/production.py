...
'''
Production Configurations for Common Repo projects.
...
# stored files.
MEDIA_URL = env('DJANGO_MEDIA_URL', default='https://s3.amazonaws.com/%s/' % AWS_STORAGE_BUCKET_NAME)
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='Common Repository <noreply@commonrepo.tw>')
EMAIL_BACKEND = 'django_mailgun.MailgunBackend'
MAILGUN_ACCESS_KEY = env('DJANGO_MAILGUN_API_KEY')
MAILGUN_SERVER_NAME = env('DJANGO_MAILGUN_SERVER_NAME')
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default='[Common Repository] ')
